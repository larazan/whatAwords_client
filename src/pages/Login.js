...
import imgLogin from "../assets/undraw_Login_re_4vu2.svg";
    ...
    <>
      <div className="flex min-h-screen bg-white">
        <div className="w-1/2 flex items-center justify-center bg-cover md:block2 hidden2">
          <img src={imgLogin} className="mx-auto" alt="login image" />
        </div>
        ...
        <div className="md:w-1/2 max-w-lg mx-auto my-24 px-4 py-5 shadow-none">
          ...
          <form onSubmit={submitHandler} className="flex flex-col space-y-5">
            ...
            <div>
              <button
                type="submit"
                className="w-full px-4 py-3 text-lg font-semibold text-white transition-colors duration-300 bg-blue-500 rounded shadow hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4"
              >
                Log in
              </button>
            </div>
          ...
          <Link to={redirect ? `/register?redirect=${redirect}` : "/register"}>
            <a className="" href="/login" data-test="Link">
              <span className="block  p-5 text-center text-gray-800  text-base font-medium">
