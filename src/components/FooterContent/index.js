      ...
      <div className=" fixed bottom-0 z-20 w-full ">
        <div className="">
          <div className="flex justify-around w-full items-center bg-pink-600 leading-none2 text-white  text-sm">
            <button
              className="flex flex-col w-full justify-center p-3 md:p-2 items-center hover:bg-pink-700 space-y-1"
              onClick={sizeHandler}
            >
              <svg
            ...
            >
              ...
              <span className="text-xs hidden md:block">Background</span>
            </button>
            <button
              className="flex flex-col w-full justify-center p-3 md:p-2 items-center hover:bg-pink-700 space-y-1"
